...
//		robot.setCursorPos(p);
//		robot.keyClick('d');
//	}
//
//	void levelUpAbility(const std::string& abilityMaxingOrder){
//		if (robot.isPixelSimilar(ABLE_TO_LEVEL_UP_Q, tolerance) ||
//			robot.isPixelSimilar(ABLE_TO_LEVEL_UP_W, tolerance) ||
//			robot.isPixelSimilar(ABLE_TO_LEVEL_UP_E, tolerance) || 
//			robot.isPixelSimilar(ABLE_TO_LEVEL_UP_R, tolerance)) {
//			robot.ctrlPlusKeyClick(abilityMaxingOrder[championLevel - 1]);
//			championLevel++;
//		}
//	}
//};