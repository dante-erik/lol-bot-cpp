...
constexpr Pixel FOW_MID_TOWER_1{ {1855, 902}, 52, 55, 40 };
constexpr Pixel FOW_MID_TOWER_2{ {1859, 876}, 36, 49, 52 };
constexpr Pixel FOW_MID_TOWER_3{ {1885, 858}, 41, 54, 56 };
constexpr Pixel FOW_NEXUS_TOWERS{ {1900, 834},	 41, 54, 57 };
...
constexpr POINT SAFE_ATTACK_MID_TOWER_1{1777, 948};
